        ...
        <Container>
          ...
          <div key="0" style={{ marginBottom: "20px" }}>
            <Card style={{ fontFamily: "Georgia, serif" }}>
              ...
              <CardPictureList
                pic1="https://s.hdnux.com/photos/64/37/14/13759240/3/920x920.jpg"
              ...
              <CardBody>
                ...
                <CardText>
                  Indoor cat. My first cat. She has done all vaccinations. Only
          ...
          <div key="1" style={{ marginBottom: "20px" }}>
            <Card style={{ fontFamily: "Georgia, serif" }}>
              ...
              <CardBody>
                ...
                <CardText>
                  Stray found in August 2018. Outdoor cat. Very friendly with
